...
module.exports = function (grunt) {
        ...
        files: [
          {
            expand: true,
            flatten: true,
            src: ["<%= yeoman.dist %>/views/explore2.map.html"],
      ...
      urls: {
        options: {
          patterns: [
            ...
            {
              match: "OPENSENSEMAP_CMS_URL",
              replacement: "<%= OPENSENSEMAP_CMS_URL %>",
            },
            {
        ...
        files: [
          {
            expand: true,
            flatten: true,
            src: [".tmp/scripts/constants.js"],
            dest: ".tmp/scripts",
          },
          {
            expand: true,
            flatten: true,
            src: [".tmp/scripts/services/opensensemapapi.js"],
        ...
        files: [
          {
            expand: true,
            flatten: true,
            src: [".tmp/components/leaflet.directive.js"],
            dest: ".tmp/components",
          },
        ],
      },
      ...
      livereload: {
        options: {
          ...
          middleware: function (connect, options) {
            ...
            middlewares.push(
              modRewrite([
                "!\\.html|\\.js|\\.css|\\.svg|\\.jp(e?)g|\\.png|\\.woff2|\\.gif|\\.ttf$ /index.html",
              ])
            );
    ...
    compress: {
      gzip: {
        ...
        files: [
          ...
          {
            expand: true,
            src: ["dist/translations/angular/*.js"],
            dest: "./",
            extDot: "last",
            ext: ".js.gz",
          },
  ...
  grunt.registerTask('loadconst', 'Load constants', function (target) {
    console.log('Load constants: ', process.env.OPENSENSEMAP_API_URL, process.env.OPENSENSEMAP_STYLE_URL, process.env.OPENSENSEMAP_ACCESS_TOKEN, process.env.OPENSENSEMAP_CMS_URL);
    grunt.config('OPENSENSEMAP_API_URL', process.env.OPENSENSEMAP_API_URL);
    grunt.config('OPENSENSEMAP_CMS_URL', process.env.OPENSENSEMAP_CMS_URL);
